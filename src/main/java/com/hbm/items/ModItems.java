...
public class ModItems {
	...
	public static Item turbine_stainless;
	...
	{			
		...
		turbine_stainless = new Item().setUnlocalizedName("turbine_syngas").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":turbine_syngas");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(turbine_stainless, turbine_stainless.getUnlocalizedName());
