...
public class ModItems {
	...
	public static Item gun_morita;
	public static Item gun_morita_carbine;
	...
	public static Item gun_typewriter;
	...
	{			
		...
		mp_warhead_10_nuclear_large = new ItemMissile().makeWarhead(WarheadType.TX, 100F, 2.5F, PartSize.SIZE_10).setTitle("Chernobyl Boris").setHealth(15F).setUnlocalizedName("mp_warhead_10_nuclear_large").setMaxStackSize(1).setCreativeTab(MainRegistry.missileTab).setTextureName(RefStrings.MODID + ":mp_warhead");
		...
		gun_typewriter = new ItemGunBase(Gun45ACPFactory.getTypewriterConfig()).setUnlocalizedName("gun_typewriter").setCreativeTab(MainRegistry.weaponTab).setTextureName(RefStrings.MODID + ":gun_thompson");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(gun_morita, gun_morita.getUnlocalizedName());
		GameRegistry.registerItem(gun_morita_carbine, gun_morita_carbine.getUnlocalizedName());
		...
		GameRegistry.registerItem(gun_typewriter, gun_typewriter.getUnlocalizedName());
