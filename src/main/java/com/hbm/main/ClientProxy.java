...
public class ClientProxy extends ServerProxy {
	...
	public void registerItemRenderer() {
		...
		MinecraftForgeClient.registerItemRenderer(ModItems.gun_lever_action_akimbo, new ItemRenderWeaponFFMaresLeg(ResourceManager.ff_gun_normal, ResourceManager.ff_wood_red));
		...
		MinecraftForgeClient.registerItemRenderer(ModItems.gun_typewriter, new ItemRenderWeaponThompson());
		...
		MinecraftForgeClient.registerItemRenderer(ModItems.gun_morita, new ItemRenderWeaponMorita());
		MinecraftForgeClient.registerItemRenderer(ModItems.gun_morita_carbine, new ItemRenderWeaponMorita());
