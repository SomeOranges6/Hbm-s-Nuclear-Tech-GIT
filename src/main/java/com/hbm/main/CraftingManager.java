...
public class CraftingManager {
	...
	public static void reg2() {
		...
		addShapelessAuto(new ItemStack(ModBlocks.charge_dynamite, 1), new Object[] { ModItems.grenade.stackFromEnum(AmmoHandGrenade.DYNAMITE), ModItems.grenade.stackFromEnum(AmmoHandGrenade.DYNAMITE), ModItems.grenade.stackFromEnum(AmmoHandGrenade.DYNAMITE), ModItems.ducttape });
		...
		addRecipeAuto(new ItemStack(ModItems.key_kit, 1), new Object[] { "PKP", "DTD", "PKP", 'P', AU.plate(), 'K', ModItems.key, 'D', DESH.dust(), 'T', ModItems.screwdriver });
		...
		addShapelessAuto(new ItemStack(ModItems.catalyst_clay), new Object[] { NI.dust(), Items.clay_ball });
		...
		addRecipeAuto(new ItemStack(ModBlocks.vent_pink_cloud), new Object[] { "IGI", "ICI", "IDI", 'I', FE.plate(), 'G', Blocks.iron_bars, 'C', ModItems.grenade.stackFromEnum(AmmoHandGrenade.PINK_CLOUD), 'D', Blocks.dispenser });
	...
	public static void crumple() {
		...
		if(Loader.isModLoaded("Mekanism")) {
			...
			List<IRecipe> toDestroy = new ArrayList<IRecipe>();
