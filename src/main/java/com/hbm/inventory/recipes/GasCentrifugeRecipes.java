...
public class GasCentrifugeRecipes {
	...
	public static class PseudoFluidType {
		...
		public static PseudoFluidType PAIN_LIGHT	= new PseudoFluidType("PAIN_LIGHT",	500,	0,		NONE,		true,	new ItemStack(ModItems.gem_tantalium, 1), new ItemStack(ModItems.powder_iron, 1), new ItemStack(ModItems.powder_calcium, 1));
		public static PseudoFluidType PAIN		= new PseudoFluidType("PAIN", 		1000,	500,	PAIN_LIGHT,	false,	new ItemStack(ModItems.gem_tantalium, 1), new ItemStack(ModItems.powder_iron, 1));
		public static PseudoFluidType MONAZITE		= new PseudoFluidType("MONAZITE", 		800,	0,	NONE,	false,	new ItemStack(ModItems.powder_neodymium, 4), new ItemStack(ModItems.nugget_zirconium, 6), new ItemStack(ModItems.powder_quartz, 1),  new ItemStack(ModItems.nugget_th232, 1));
	...
	public static void register() {
		...
		fluidConversions.put(Fluids.PAIN, PseudoFluidType.PAIN);
		fluidConversions.put(Fluids.MONAZITE_SOLUTION, PseudoFluidType.MONAZITE);
		...
		gasCent.put(new FluidStack(1000, Fluids.PAIN), new Object[] { new ItemStack[] {new ItemStack(ModItems.gem_tantalium, 2), new ItemStack(ModItems.powder_iron, 2), new ItemStack(ModItems.powder_calcium, 1)}, true, 2 });
		...
		gasCent.put(new FluidStack(800, Fluids.MONAZITE_SOLUTION), new Object[] { new ItemStack[] {new ItemStack(ModItems.powder_neodymium, 4), new ItemStack(ModItems.nugget_zirconium, 6), new ItemStack(ModItems.powder_quartz, 1),  new ItemStack(ModItems.nugget_th232, 1)}, false, 1 });
	}
}
