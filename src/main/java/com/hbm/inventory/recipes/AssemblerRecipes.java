...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.mp_warhead_15_thermo_moon, 1), new AStack[] {new ComparableStack(ModItems.seg_15, 1), new OreDictStack(STEEL.plate(), 32), new OreDictStack(TI.plate(), 28), new OreDictStack(PU239.ingot(), 4), new ComparableStack(ModBlocks.det_charge, 8), new ComparableStack(ModItems.circuit_targeting_tier4,  1), new ComparableStack(ModItems.tritium_deuterium_cake,  1), },500);
		...
		makeRecipe(new ComparableStack(ModItems.mp_warhead_15_schrab, 1), new AStack[] {new ComparableStack(ModItems.seg_15, 1), new OreDictStack(OreDictManager.getReflector(), 16), new OreDictStack(SA326.ingot(), 8), new OreDictStack(ANY_HIGHEXPLOSIVE.ingot(), 12), new ComparableStack(ModItems.circuit_targeting_tier4, 1), new OreDictStack(STEEL.plate(), 24), new OreDictStack(TI.plate(), 12), }, 60);
