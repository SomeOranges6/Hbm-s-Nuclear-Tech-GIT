...
public class Mats {
	...
	public static final NTMMaterial MAT_ALUMINIUM	= makeSmeltable(1300,		AL,			0xFFFFFF, 0x344550, 0xD0B8EB).setShapes(WIRE, INGOT, DUST, PLATE, CASTPLATE, PIPE, WELDEDPLATE, SHELL, BLOCK, HEAVY_COMPONENT).m();
	public static final NTMMaterial MAT_LEAD		= makeSmeltable(8200,		PB,			0xA6A6B2, 0x03030F, 0x646470).setShapes(NUGGET, WIRE,  INGOT, DUST, PLATE, CASTPLATE, PIPE, BLOCK, WELDEDPLATE, HEAVY_COMPONENT).m();
	...
	public static final NTMMaterial MAT_EMERALD		= make(			401,		EMERALD)	.setConversion(MAT_BERYLLIUM, 4, 3).m();
	...
	public static final NTMMaterial MAT_ALLOY		= makeSmeltable(_AS + 2,	ALLOY,		0xFF8330, 0x700000, 0xFF7318).setShapes(WIRE, INGOT, DUST, DENSEWIRE, PLATE, CASTPLATE, WELDEDPLATE, BLOCK, HEAVY_COMPONENT).m();
	...
	public static final NTMMaterial MAT_CMB			= makeSmeltable(_AS + 9,	CMB,		0x6F6FB4, 0x000011, 0x6F6FB4).setShapes(INGOT, DUST, PLATE, CASTPLATE, WELDEDPLATE, BLOCK, HEAVY_COMPONENT).m();
