...
public class BulletConfigSyncingUtil {
	...
	public static void loadConfigsForSync() {
		...
		configSet.put(R762_NORMAL_HS, Gun762mmFactory.get762NATOConfig().setHeadshot(4F));
		configSet.put(R762_PHOSPHORUS_HS, Gun762mmFactory.get762WPConfig().setHeadshot(4F));
		configSet.put(R762_AP_HS, Gun762mmFactory.get762APConfig().setHeadshot(4F));
		configSet.put(R762_DU_HS, Gun762mmFactory.get762DUConfig().setHeadshot(4F));
		configSet.put(R762_TRACER_HS, Gun762mmFactory.get762TracerConfig().setHeadshot(4F));
		configSet.put(R762_K_HS, Gun762mmFactory.get762BlankConfig().setHeadshot(4F));
