...
public class WeaponRecipes {
	...
	public static void register() {
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_lever_action_dark, 1), new Object[] { "PPI", 'P', STEEL.plate(), 'I', ModItems.gun_lever_action });
		CraftingManager.addShapelessAuto(new ItemStack(ModItems.gun_lever_action_akimbo, 1), new Object[] { ModItems.gun_lever_action_dark,ModItems.gun_lever_action_dark});
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.ammo_12gauge, 24), new Object[] { " I ", "GCL", 'I', ModItems.pellet_buckshot, 'G', ModItems.cordite, 'C', ModItems.casing_buckshot, 'L', ModItems.plate_polymer });
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.ammo_12gauge, 24), new Object[] { " I ", "GCL", 'I', ModItems.pellet_buckshot, 'G', ModItems.ballistite, 'C', ModItems.casing_buckshot,  'L', ModItems.plate_polymer });
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.ammo_4gauge, 24), new Object[] { " I ", "GCL", 'I', ModItems.pellet_buckshot, 'G', ModItems.cordite, 'C', ModItems.casing_50, 'L', ModItems.plate_polymer });
