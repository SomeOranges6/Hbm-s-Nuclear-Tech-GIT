...
public class WeaponRecipes {
	...
	public static void register() {
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_revolver_saturnite, 1), new Object[] { "SSR", "TWM", 'S', BIGMT.plate(), 'W', DURA.bolt(), 'T', ModItems.wire_tungsten, 'R', ModItems.gun_revolver,'M', ModItems.motor });
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.gun_ks23, 1), new Object[] { "PPM", "SWL", 'P', ModItems.hull_small_steel, 'M', ModItems.mechanism_rifle_1, 'S', DURA.bolt(), 'W', ModItems.wire_tungsten, 'L', KEY_LOG });
