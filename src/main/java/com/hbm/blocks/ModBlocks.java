...
public class ModBlocks {
	...
	private static void initializeBlock() {
		...
		brick_concrete_broken = new BlockFalling(Material.rock).setBlockName("brick_concrete_broken").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(45.0F).setBlockTextureName(RefStrings.MODID + ":brick_concrete_broken");
		...
		concrete_debris = new BlockEnumMulti(Material.rock, EnumDebrisType.class, false, true).setBlockName("concrete_debris").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(30.0F).setBlockTextureName(RefStrings.MODID + ":concrete_debris");
		ducrete_debris = new BlockEnumMulti(Material.rock, EnumDebrisType.class, false, true).setBlockName("ducrete_debris").setCreativeTab(MainRegistry.blockTab).setHardness(15.0F).setResistance(60.0F).setBlockTextureName(RefStrings.MODID + ":ducrete_debris");
