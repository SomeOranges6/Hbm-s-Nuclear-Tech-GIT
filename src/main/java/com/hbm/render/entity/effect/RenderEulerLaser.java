...
public class RenderEulerLaser extends Render {
	...
	public void doRender(Entity entity, double x, double y, double z, float p_76986_8_, float p_76986_9_) {
		double alpha = (((double)entity.ticksExisted) / ((double)EntityEulerLaser.maxAge));
		GL11.glPushMatrix();
		...
		GL11.glPushMatrix();
	        ...
	        GL11.glColor4d(0, 1.0, 0, alpha);
	        
	        Vec3 vector = Vec3.createVectorHelper(2D, 0, 0);
	...
	public void renderOrb(Entity entity, double x, double y, double z, float p_76986_8_, float p_76986_9_) {
		...
		if (expanding == false){
		 scale = 30 - 50D * (((double)entity.ticksExisted) / ((double)EntityEulerLaser.maxAge));
		} else {
		 scale = 1 + 20D * (((double)entity.ticksExisted) / ((double)EntityEulerLaser.maxAge));	
		}
		double alpha = (((double)entity.ticksExisted) / ((double)EntityEulerLaser.maxAge));
        ...
        GL11.glColor4d(0, 1.0, 0, alpha * 0.125);
